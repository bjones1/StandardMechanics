...
#
    def __init__(self, serialPort, baudRate=9600, dataLength=serial.EIGHTBITS, stopBit=serial.STOPBITS_ONE, parity=serial.PARITY_NONE, XonXoff=False, timeout=None):
        ...
        # Call all respective functions for configuration
        self.SetBaudRate(baudRate)
        self.SetLineRate(self.lineRate)
        self.SetCLClock(self.CCLK)
        self.SetExposureMode(self.exposureMode)
        self.SetGainLevel(self.gainLevel)
        self.SetAnalogBaseGain(self.analogBaseGain)
        self.SetDeviceTapGeometry(self.deviceTapGeometry)
